...
function RecuiterNew() {
 ...
 var username=""
  ...
  try{
  const response =await fetch("https://backend-jazee.onrender.com/recuiter/new",{
    method:"POST",
    body:formDatatosend
  });
  ...
  if(response.ok)
  {
    alert(resp.message+"navigating to recuiter page");
    navigate("/recuiter");
